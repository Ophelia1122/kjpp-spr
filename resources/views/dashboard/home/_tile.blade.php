...
@endif
    ...
    <div class="mt-1 text-3xl font-bold tabular-nums {{ $valueTone }}">{{ $value }}</div>
    @if (! empty($sub))
        <div class="text-sm font-semibold text-gray-700 tabular-nums dark:text-gray-300">{{ $sub }}</div>
    @endif
