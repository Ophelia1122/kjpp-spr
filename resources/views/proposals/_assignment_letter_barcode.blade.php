...
@if ($project->assignment_letter_barcode)
    <div class="mt-1 flex items-center gap-3">
        ...
        <form action="{{ route('projects.assignmentLetterBarcode.destroy', $project) }}" method="POST"
              ...
              data-confirm="Hapus barcode ini?">
            @csrf
            @method('DELETE')
...
@else
    {{-- PNG atau JPG/JPEG (2026-09-14, feedback user). --}}
    <input type="file" name="assignment_letter_barcode" id="assignmentLetterBarcodeInput" accept="image/png,image/jpeg,.png,.jpg,.jpeg"
