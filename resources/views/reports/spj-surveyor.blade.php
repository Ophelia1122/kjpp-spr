...
<div class="max-w-7xl mx-auto py-8 space-y-6">
    ...
    @empty
        <div class="rounded-lg border border-gray-200 bg-white p-10 text-center text-sm text-gray-500 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-500">
