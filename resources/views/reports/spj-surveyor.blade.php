...
<div class="max-w-7xl mx-auto py-8 space-y-6">
    ...
    <x-page-header title="SPJ Surveyor"
        ...
        <div class="flex items-center gap-4">
            <div>
                <p class="text-[11px] uppercase tracking-wide text-gray-500 dark:text-gray-400">Proyek</p>
            ...
            <div class="border-l border-gray-200 pl-4 dark:border-gray-700">
                <p class="text-[11px] uppercase tracking-wide text-gray-500 dark:text-gray-400">Objek</p>
