            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                @forelse ($banks as $bank)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/60">
                        ...
                        <td class="px-4 py-3 text-gray-500 dark:text-gray-500">{{ $bank->branch ?: '—' }}</td>
                        <td class="px-4 py-3 text-gray-600 font-mono dark:text-gray-500">{{ $bank->account_number }}</td>
                        <td class="px-4 py-3 text-gray-500 dark:text-gray-500">{{ $bank->account_name }}</td>
                            ...
                            <div class="flex justify-center items-center gap-1.5">
                                ...
                                @else
                                    <span title="Masih dipakai di proposal — tidak dapat dihapus"
                                          class="grid h-8 w-8 place-items-center rounded-md text-gray-300 cursor-not-allowed dark:text-gray-500">
                                        <svg aria-hidden="true" class="h-[18px] w-[18px]" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0"/>
                                        </svg>
                                    </span>
