    ...
    <div class="md:hidden bg-white rounded-lg border border-gray-200 shadow-sm divide-y divide-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:divide-gray-700">
            ...
            <div class="space-y-1.5 px-4 py-3">
                <div class="flex items-start justify-between gap-3">
                    <div class="min-w-0">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">{{ $client->client_type }}</p>
                    </div>
                    @can('clients.manage')
                ...
                <p class="text-xs text-gray-500 whitespace-pre-line line-clamp-3 dark:text-gray-400">{{ $client->address ?: '—' }}</p>
                @if ($usageCount > 0)
        ...
        @empty
            <p class="px-4 py-10 text-center text-sm text-gray-400 dark:text-gray-500">Belum ada klien.</p>
        @endforelse
    </div>
