{{-- Petunjuk untuk tabel lebar yang bisa digeser di HP (2026-09-15, feedback user). --}}
<p class="flex items-center justify-end gap-1 px-4 pt-2 text-xs text-gray-400 md:hidden dark:text-gray-400">
