...
<span title="{{ $tip }}" tabindex="0"
      class="ml-1 inline-flex cursor-help align-middle text-gray-400 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300">
    <svg aria-hidden="true" class="h-[15px] w-[15px]" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor">
