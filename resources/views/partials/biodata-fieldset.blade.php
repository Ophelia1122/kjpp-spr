...
<fieldset class="rounded-md border border-gray-200 p-4 space-y-4 dark:border-gray-700">
    ...
    <div data-bio="pj" class="hidden space-y-4">
        ...
        <div>
            ...
            @php $bioSectors = (array) old('ojk_sectors', $bioUser->ojk_sectors ?? []); @endphp
            ...
            <textarea id="ojk_sectors_other" name="ojk_sectors_other" rows="2" placeholder="Contoh: Pergadaian"
                      class="mt-1 w-full rounded-md border-gray-300 text-sm shadow-sm dark:border-gray-600">{{ old('ojk_sectors_other', collect($bioUser->ojk_sectors ?? [])->diff(\App\Models\User::OJK_SECTORS)->implode("\n")) }}</textarea>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="sm:col-span-2">
                ...
                <input type="text" name="pertanahan_izin_no" value="{{ old('pertanahan_izin_no', $bioUser->pertanahan_izin_no) }}"
